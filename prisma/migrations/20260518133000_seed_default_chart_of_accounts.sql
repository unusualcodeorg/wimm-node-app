-- Migration: Seed default chart of accounts
-- Created: 2026-05-18
-- Description:
--   - Creates helper function to seed default accounts for a company
--   - Seeds default chart-of-accounts rows for existing companies
...
GRANT EXECUTE ON FUNCTION public.seed_company_default_accounts(BIGINT, UUID) TO authenticated;
...
BEGIN
  ...
  LOOP
    PERFORM public.seed_company_default_accounts(company_row.id, company_row.created_by);
  END LOOP;
END;
$$;
