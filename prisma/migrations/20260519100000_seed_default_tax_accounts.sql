-- Migration: Seed default tax-related accounts
-- Created: 2026-05-19
-- Description:
--   - Extends the default chart-of-accounts seed helper with recoverable tax accounts
--   - Backfills the missing tax accounts for existing companies
