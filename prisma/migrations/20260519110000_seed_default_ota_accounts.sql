-- Migration: Seed default OTA clearing and commission accounts
-- Created: 2026-05-19
-- Description:
--   - Extends the default chart-of-accounts seed helper with missing OTA defaults
--   - Backfills the missing OTA-specific accounts for existing companies

-- Note:
--   - Booking.com Clearing (2200), OTA Commission Payable (2220), and
--     Booking.com Commission (6300) were already included in earlier seed work.
--   - This migration closes the remaining Airbnb clearing and commission gaps.
...
BEGIN
  ...
  FROM (
    VALUES
      ...
      ('2200', 'Booking.com Clearing', 'liability'::public.account_type, 'ota_clearing_booking_com', 'credit'::public.account_normal_balance),
      ('2210', 'Airbnb Clearing', 'liability'::public.account_type, 'ota_clearing_airbnb', 'credit'::public.account_normal_balance),
      ...
      ('6300', 'Booking.com Commission', 'expense'::public.account_type, 'ota_commission_expense_booking_com', 'debit'::public.account_normal_balance),
      ('6310', 'Airbnb Commission', 'expense'::public.account_type, 'ota_commission_expense_airbnb', 'debit'::public.account_normal_balance),
